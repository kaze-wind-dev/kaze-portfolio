  ...
  return (
    <>
      ...
      <div className="l-container">
        <section className={`${styles["p-privacy"]}`}>
          <div className="inner">
          

            <section className={`${styles["p-privacy__section"]}`}>
              <h3 className={`${styles["p-privacy__section-title"]}`}>
                1. 個人情報の取得について
              </h3>
              <p className={`${styles["p-privacy__text"]}`}>
                当サイトでは、お問い合わせフォームを通じて以下の情報を取得することがあります：
              </p>
              <ul className={`${styles["p-privacy__list"]}`}>
                <li className={`${styles["p-privacy__list-item"]}`}>お名前</li>
                <li className={`${styles["p-privacy__list-item"]}`}>
                  メールアドレス
                </li>
                <li className={`${styles["p-privacy__list-item"]}`}>
                  お問い合わせ内容
              ...
              <ul>
                <li className={`${styles["p-privacy__list-item"]}`}>
                  <Link
                    ...
                    className={`${styles["p-privacy__link"]}`}
                  >
            ...
            <div className={`${styles["p-privacy__section"]}`}>
              <p
                className={`${styles["p-privacy__text"]}`}
              >
                制定日：2025年8月8日
                <br />
                最終更新日：2025年8月8日
